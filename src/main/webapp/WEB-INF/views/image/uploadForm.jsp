          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto mt-4">
            <div class="row align-items-center">
              <div class="col-xl-10 col-12">
                <h2 class="text-muted text-center mb-5 mt-5" style="margin-left:10%;">이미지 등록</h2>
                ...
                <div class="container" style="margin-left:10%;">
                  <form role="form" action="uploadFormPOST" method="post" enctype="multipart/form-data" autocomplete="off">              
                    ...
                    <div class="inputArea form-group" style="margin-bottom: 50px;">
                      <label for="raw_image_path">등록하길 원하는 이미지를 선택하세요.</label></br>
                      <input class="form-control form-control" type="file" id="raw_image_path" name="file" />
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control form-control" type="text" id="price" name="price"> <br>
                      
                      <label for="raw_image_title">제목</label> 
                      <input class="form-control form-control" type="text" id="raw_image_title" name="raw_image_title"><br>
                      
                      <label for="raw_image_content">설명</label> 
                      <textarea class="form-control" rows="3" type="textarea" id="raw_image_content" name="raw_image_content"></textarea><br>
                    
                      <button type="submit" class="inquiry_btn btn btn-primary float-right" style="margin-top: 0px;">등록</button>
                    </div>
                  </form>
                </div>
