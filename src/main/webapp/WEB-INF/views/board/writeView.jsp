							...
							<div class="container" style="margin-left: 10%">
								...
								<form name="writeForm" method="post" action="/board/write">
									<div class="form-group">
										...
										<input class="chk form-control form-control" type="text" id="title" name="title"  title="제목을 입력하세요." />
										<br>
										
										<label for="content">내용</label>
										<textarea class="chk form-control" rows="5" id="content" name="content" title="내용을 입력하세요."></textarea>
										<br>
										
										<button type="button" class="list_btn btn btn-primary float-right" style="margin: 0 0;">
											<span class="fas fa-list-alt" aria-hidden="true"></span>취소
										</button>
										<button type="submit" class="write_btn btn btn-primary float-right" style="margin: 0 0.5rem;">
