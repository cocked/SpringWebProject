...
<html>
  ...
  $(document).ready(function(){
		...
		$(".sell_inquiry_btn").on("click", function(){
			location.href = "/myPage/contractManage";
		})
		
		$(".buy_inquiry_btn").on("click", function(){
			location.href = "/myPage/contractManage";
		})
	})
  </script>
          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto mt-4">
            <div class="row align-items-center">
              <div class="col-xl-10 col-12">
                  ...
                  <tbody>
                 	...
                 	<c:set var="count" value="${count+1}"></c:set>
  					 	<tr>
                      		...
                      		<td><c:out value="${sellList.seller}"></c:out></td>
                       		<td><c:out value="${sellList.buyer}"></c:out></td>
                       		<td><c:out value="${sellList.ethereum}"></c:out></td>
                      		<td><fmt:formatDate value="${sellList.regdate}" pattern="yyyy-MM-dd HH:mm"></fmt:formatDate></td>                      
                      		<td><span class="badge badge-success w-75 py-2">Clear</span></td>
                    	</tr>
                ...
                <button type="submit" onclick="location.href='/myPage/sellContractManage'" 
                class="sell_inquiry_btn btn btn-primary float-right">조회</button>
                 <!-- pagination -->
                 <nav>
        ...
        <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
          <div class="row align-items-center">
            <div class="col-xl-10 col-12">
                  ...
                  <c:set var="count1" value="0"/>
                 	...
                 	<c:forEach items="${buyList}" var="buyList">
                 		<c:set var="count1" value="${count1 + 1}"/>
  					 	...
  					 	<tr>
                      		<th><c:out value="${count1}" escapeXml="true"></c:out></th>
                      		<td><c:out value="${buyList.buyer}"></c:out></td>
                       		<td><c:out value="${buyList.seller}"></c:out></td>
                       		<td><c:out value="${buyList.ethereum}"></c:out></td>
                      		<td><fmt:formatDate value="${buyList.regdate}" pattern="yyyy-MM-dd HH:mm"></fmt:formatDate></td>                      
                      		<td><span class="badge badge-success w-75 py-2">Clear</span></td>
                    	</tr>
              ...
              <button type="submit" onclick="location.href='/myPage/buyContractManage'" 
              class="buy_inquiry_btn btn btn-primary float-right">조회</button>
               <!-- pagination -->
               <nav>
                <ul class="pagination justify-content-center">
                  <li class="page-item">
        ...
        <div class="row">
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row border-top pt-3">
              ...
              <div class="col-lg-6 text-center">
                <p>&copy; 2020 Copyright. Made With <i class="fas fa-heart text-danger"></i> by <span class="text-success">JAYASOU</span></p>
              </div>
            </div>
          </div>
        </div>
